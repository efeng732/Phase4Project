...
game11 = Game.create(name:'Borderlands 2', price: 3, system: 'XBOX, Playstation, PC', genre: 'Shooter', rating: 90, image: 'https://upload.wikimedia.org/wikipedia/en/5/51/Borderlands_2_cover_art.png')
...
game19 = Game.create(name:'Animal Crossing: New Horizons', price: 10, system: 'Nintendo Switch', genre: 'RPG', rating: 87, image: 'https://www.eaglevoice.com/wp-content/uploads/2020/04/Animal-Crossing_-New-Horizons.png')
...
game26 = Game.create(name: "Super Mario Odyssey", price: 5, system: "Nintendo Switch", genre: "Adventure", rating: 95, image: "https://upload.wikimedia.org/wikipedia/en/8/8d/Super_Mario_Odyssey.jpg")
game27 = Game.create(name: "Devil May Cry 5", price: 15, system: "XBOX, Playstation, PC, Nintendo Switch", genre: "Action", rating: 95, image: "https://upload.wikimedia.org/wikipedia/en/c/cb/Devil_May_Cry_5.jpg")
game28 = Game.create(name: "Battlefield V", price: 10, system: "XBOX, Playstation, PC", genre: "Shooter", rating: 75, image: "https://upload.wikimedia.org/wikipedia/en/thumb/f/f0/Battlefield_V_standard_edition_box_art.jpg/220px-Battlefield_V_standard_edition_box_art.jpg")

puts 'adding to carts'
cart1 = Cart.create(user_id: 1, current: false)
cart2 = Cart.create(user_id: 1, current: true)
cart3= Cart.create(user_id: 1, current: false)
...
# rental6 = Rental.create(cart_id: 1, game_id: 24, duration: 6)
...
rental11 = Rental.create(cart_id: 3, game_id: 8, duration: 2)
rental12 = Rental.create(cart_id: 3, game_id: 19, duration: 1)
rental13 = Rental.create(cart_id: 3, game_id: 12, duration: 3)
...
review11= Review.create(user_id: 1, game_id: 8, content: "What a soul-crushing game. I'm just vibing, first place the entire race until the last bit of the last lap and I get bombarded by 20 random items and drop to 10th. Happens everytime, why can I not stop myself from playing this rage-inducing game?", title: 'I hate blue shells')
review12= Review.create(user_id: 1, game_id: 19, content: "You get kidnapped by a raccoon and he gives you your own island, sounds pretty nice right? No, because he keeps on finding new ways to charge you for stuff and everytime you manage to pay it off through hours of back-breaking labor, another fat bill drops out of the sky. This game is too real, I cannot escape poverty.", title: 'Always in debt just like real life')
review13= Review.create(user_id: 1, game_id: 12, content: "Too scary. Needed fresh change of pants within the first 15 minutes, and that's also the same amount of sleep I got that night.", title: 'AAAAAAAHHHHHH')
